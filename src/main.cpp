...
int main(int argc, char *argv[])
{
 ...
 /*   auto libro = std::make_shared<Book>("Il Signore Degli Spinelli", "a", 1, "percorso/esempio", "autore", "size", "publisher", "genre", "edition");
    ...
    auto series = std::make_shared<Series>("Piggly Winks", "a", 1, "percorso/esempio", "publisher", "genre", "cast", "director", 1, 2);
    auto videogame = std::make_shared<Videogame>("Clair Obscur", "a", 1, "percorso/esempio", "publisher", "genre", "developer");
