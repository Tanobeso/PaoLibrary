...
Book::Book(string _title, string _description, unsigned int _year, string _image, string _author, string _size, string _publisher, string _genre, string _edition): PhysicalItem(_title, _description, _year, _image, _author, _size), publisher(_publisher), genre(_genre), edition(_edition){
};
...
void Book::setEdition(const string& e){
    this->edition=e;
};
